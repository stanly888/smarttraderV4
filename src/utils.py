...
def fetch_real_data(config=None, mode="live", symbol="BTC/USDT", interval="15m", limit=100):
    """
    模擬從交易所取得資料，支援 live / backtest 模式。
    """
    ...
    return list(reversed(data))  # 時間由舊到新import os
import json
import datetime
import random
